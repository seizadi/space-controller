...
func (c *Controller) updateFooStatus(foo *samplev1alpha1.Space, deployment *appsv1.Deployment) error {
...
func newDeployment(foo *samplev1alpha1.Space) *appsv1.Deployment {
