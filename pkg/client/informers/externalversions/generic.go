...
func (f *sharedInformerFactory) ForResource(resource schema.GroupVersionResource) (GenericInformer, error) {
	switch resource {
	// Group=spacecontroller.seizadi.github.com, Version=v1alpha1
	case v1alpha1.SchemeGroupVersion.WithResource("spaces"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Spacecontroller().V1alpha1().Spaces().Informer()}, nil
