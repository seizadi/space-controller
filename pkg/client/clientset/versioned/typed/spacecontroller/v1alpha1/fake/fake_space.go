...
var spacesResource = schema.GroupVersionResource{Group: "spacecontroller.seizadi.github.com", Version: "v1alpha1", Resource: "spaces"}

var spacesKind = schema.GroupVersionKind{Group: "spacecontroller.seizadi.github.com", Version: "v1alpha1", Kind: "Space"}
...
func (c *FakeSpaces) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.Space, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(spacesResource, c.ns, name, data, subresources...), &v1alpha1.Space{})
